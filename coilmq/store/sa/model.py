...
#: The :class:`sqlalchemy.Table` set by :func:`setup_tables`
frames_table = None
...
def setup_tables(create=True, drop=False):
    ...
    This function expects that you have bound the :obj:`coilmq.store.sa.meta.metadata` and :obj:`coilmq.store.sa.meta.engine`.
